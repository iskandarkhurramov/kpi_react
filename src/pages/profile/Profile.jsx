          ...
          <div className="grid grid-cols-2 mt-10">
            ...
            <div className="md:col-span-1 col-span-2 bg-gray-300 p-2 md:p-5 min-h-fit md:m-5 my-5 basis-11/12">
              ...
              <div className="flex mt-4">
                <div className="basis-1/2 flex flex-col text-center w-full h-auto bg-white mx-2 rounded p-3">
                  <span className="block font-medium md:text-base text-xs text-gray-500">
                    Sizning natijangiz:
                  </span>
                  <span className="font-bold text-xl md:text-4xl text-indigo-700">
                    20
                  </span>
                </div>
                <div className="basis-1/2 flex flex-col text-center w-full h-auto bg-white mx-2 rounded p-3">
                  ...
                  <span className="font-bold text-xl md:text-4xl text-lime-600">
                    20
                  </span>
                </div>
              </div>
